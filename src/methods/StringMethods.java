...
public class StringMethods {
    ...
    /**
     *  Q1
     *  Create method for abbreviation
     *  Purpose - user provides string, method turns it into abbreviaiton
     *  Requires only 1 input
     *  - I need to split sentence into separate words
     *  - Using loop, I target first char of every word
     *  - Add each char into empty string variable
     *  - Return final result that holds abbreviation
     */
