...
public class Homework8 {
    ...
    /**
     *  Comments:
     *  Deepak provided great example using Calendar class and HOUR & ADD methods.
     *  His example is definitely better solution and solves this question more efficiently.
     *  It makes more sense to use methods rather than hardcoding output
     */
}
